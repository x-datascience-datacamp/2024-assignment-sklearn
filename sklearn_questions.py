...
class MonthlySplit(BaseCrossValidator):
    ...
    def get_n_splits(self, X, y=None, groups=None):
        ...
        unique_mth = time_col.dt.to_period('M').unique()
    ...
    def split(self, X, y=None, groups=None):
        ...
        unique_mths = time_periods.unique()

        for i in range(len(unique_mths) - 1):
            train_mth = unique_mths[i]
            test_mth = unique_mths[i + 1]

            train_msk = time_periods == train_mth
            test_msk = time_periods == test_mth

            idx_train = X_sorted.index[train_msk]
            idx_test = X_sorted.index[test_msk]
